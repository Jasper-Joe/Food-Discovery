    ...
    private func fetchNotifications() {
        for x in 0...100 {
            let user = User(username: "sntasssion",
                            bio: "",
                            name: (first: "", last: ""),
                            profilePhoto: URL(string: "https://www.foodDiscovery.com")!,
                            birthDate: Date(),
                            gender: .male,
            ...
            let post = UserPost(identifier: "",
                                postType: .photo,
                                thumbnailImage: URL(string: "https://www.foodDiscovery.com")!,
                                postURL: URL(string: "https://www.foodDiscovery.com")!,
                                caption: nil,
                                likeCount: [],
                                comments: [],
                                createdDate: Date(),
